# Echo client/server with go-libp2p-vsock

This is an example that quickly shows how to use the `go-libp2p-vsock` stack, including Host/Basichost, Network/Swarm, Streams, Peerstores and Multiaddresses.
...
From the `libp2p-vsock` directory run the following:
